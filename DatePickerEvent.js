...
// goto line ~ 771 to see the code to enable the dates

Ext.DatePickerEvent = Ext.extend(Ext.BoxComponent, {
    /**
     ...
     * <li><code>picker</code> : DatePickerEvent<div class="sub-desc">This DatePickerEvent.</div></li>
     ...
     * function will be called.  Defaults to this DatePickerEvent instance.
     */
    /**
     * @cfg {String} todayTip
    ...
    // default value used to initialise each date in the DatePickerEvent
    // (note: 12 noon was chosen because it steers well clear of all DST timezone changes)
    initHour: 12, // 24-hour format

    // An array of 'dates' to enable, as strings.
    enabledDays: [],

    // private
    initComponent : function(){
        Ext.DatePickerEvent.superclass.initComponent.call(this);
        ...
        this.addEvents(
             ...
             * @param {DatePickerEvent} this DatePickerEvent
    ...
    /**
     * Replaces any existing disabled dates with new values and refreshes the DatePickerEvent.
    ...
    /**
     * Replace the enabled days.
     * @param {Array} enabledDates An array of date strings.
     * */
    setEnabledDates : function(ed){
        if(Ext.isArray(ed)){
            this.enabledDays = ed;
        }
        this.initEnabledDays();
    ...
    /**
     * Replaces any existing disabled days (by index, 0-6) with new values and refreshes the DatePickerEvent.
    ...
    /**
     * Replaces any existing {@link #minDate} with the new value and refreshes the DatePickerEvent.
    ...
    /**
     * Replaces any existing {@link #maxDate} with the new value and refreshes the DatePickerEvent.
    ...
    onEnable: function(initial){
        Ext.DatePickerEvent.superclass.onEnable.call(this);
    ...
    // private
    onDisable : function(){
        Ext.DatePickerEvent.superclass.onDisable.call(this);
    ...
    update : function(date, forceRefresh){
        if(this.rendered){
            ...
            var pm = date.add('mo', -1),
                ...
                cur_enabledDays = this.enabledDays;
            ...
            var setCellClass = function(cal, cell){
                ...
                /* our fancy custom code to enable individual date. cheers, jan */
                if(cur_enabledDays != null && cur_enabledDays.length > 0) {
                    var fvalue = d.dateFormat(format);
                    for(dayit = 0; dayit < cur_enabledDays.length; dayit++){
                        if(fvalue == cur_enabledDays[dayit]){
                            cell.className = cell.className.replace(/x-date-disabled/g, "");
                        }
                    }
                }
...
Ext.reg('datepicker', Ext.DatePickerEvent);
